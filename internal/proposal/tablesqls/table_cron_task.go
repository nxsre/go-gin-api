...
func CreateCronTaskTableSql() (sql string) {
	...
	sql += "`entry_id` int(11) COMMENT 'crontab 任务ID',"
	...
	sql += "`req_url` varchar(255) NOT NULL DEFAULT '' COMMENT 'http 请求 url',"
	sql += "`req_body` varchar(255)  NOT NULL DEFAULT '' COMMENT 'http 请求 body',"
